...
USE_SERIAL_FLASHING    = 1 # Enable experimental serial flashing support NB: Disabled if uart debugging is enabled
#------------------------------------------------------------------
...
DEFS        = -DBOOT_ADR=$(BOOT_ADR) -DF_CPU=$(F_CPU) -DUSE_LED=$(USE_LED) -DUSE_UART=$(USE_UART) -DCS_PIN=$(CS_PIN) -DVARIANT_1284P=$(VARIANT_1284P) -DUSE_SERIAL_FLASHING=$(USE_SERIAL_FLASHING)
LIBS        =
DEBUG       = dwarf-2
